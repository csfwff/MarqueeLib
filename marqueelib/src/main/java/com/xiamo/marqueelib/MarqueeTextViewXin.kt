 ...
 */
open class MarqueeTextViewXin @JvmOverloads constructor(
    context: Context?,
     ...
     * 是否用户主动调用，默认 true
     */
    protected var isRollByUser = true
    ...
    private fun initAttrs(attrs: AttributeSet?) {
        val a = context.obtainStyledAttributes(attrs, R.styleable.MarqueeTextViewXin)
        textColor = a.getColor(R.styleable.MarqueeTextViewXin_android_textColor, textColor)
        isResetLocation = a.getBoolean(R.styleable.MarqueeTextViewXin_marqueeResetLocation, true)
        speed = a.getFloat(R.styleable.MarqueeTextViewXin_marqueeSpeed, 1f)
        textSize = a.getDimension(R.styleable.MarqueeTextViewXin_android_textSize, 12f)
        textItemDistance = a.getDimension(R.styleable.MarqueeTextViewXin_marqueeItemDistance, 50f)
        startLocationDistance = a.getFloat(
            R.styleable.MarqueeTextViewXin_marqueeStartLocationDistance,
            0f
        )
        repeat = a.getInt(R.styleable.MarqueeTextViewXin_marqueeRepeat, REPEAT_SINGLE_LOOP)
        text = a.getText(R.styleable.MarqueeTextViewXin_android_text)?.toString() ?: ""
        a.recycle()
    }
     ...
     */
    private class MyHandler(view: MarqueeTextViewXin) : Handler(Looper.getMainLooper()) {
